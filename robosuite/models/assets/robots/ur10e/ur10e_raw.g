...
type:mesh mesh:'/home/sereact-mathias/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/visual/base.ply'
...
shape collision base_link_inertia_0 (base_link_inertia) {  
 color:[.8 .2 .2 .5],
rel=<T t(0 0 0) E(0 0 3.141592653589793)>
type:mesh mesh:'/home/sereact-mathias/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/collision/base.stl'
 contact:-2 }
...
rel=<T t(0 0 0) E(0 0 3.141592653589793)>
type:mesh mesh:'/home/sereact-mathias/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/visual/shoulder.ply'
color:[0.7 0.7 0.7 1.0]
colorName:LightGrey
 visual }
...
shape collision shoulder_link_0 (shoulder_link) {  
 color:[.8 .2 .2 .5],
rel=<T t(0 0 0) E(0 0 3.141592653589793)>
type:mesh mesh:'/home/sereact-mathias/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/collision/shoulder.stl'
 contact:-2 }
...
type:mesh mesh:'/home/sereact-mathias/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/visual/upperarm.ply'
color:[0.7 0.7 0.7 1.0]
colorName:LightGrey
 visual }
...
shape collision upper_arm_link_0 (upper_arm_link) {  
 color:[.8 .2 .2 .5],
rel=<T t(0 0 0.1762) E(1.5707963267948966 0 -1.5707963267948966)>
type:mesh mesh:'/home/sereact-mathias/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/collision/upperarm.stl'
 contact:-2 }
...
type:mesh mesh:'/home/sereact-mathias/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/visual/forearm.ply'
color:[0.7 0.7 0.7 1.0]
colorName:LightGrey
 visual }
...
shape collision forearm_link_0 (forearm_link) {  
 color:[.8 .2 .2 .5],
rel=<T t(0 0 0.0393) E(1.5707963267948966 0 -1.5707963267948966)>
type:mesh mesh:'/home/sereact-mathias/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/collision/forearm.stl'
 contact:-2 }
...
type:mesh mesh:'/home/sereact-mathias/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/visual/wrist1.ply'
color:[0.7 0.7 0.7 1.0]
colorName:LightGrey
 visual }
...
shape collision wrist_1_link_0 (wrist_1_link) {  
 color:[.8 .2 .2 .5],
rel=<T t(0 0 -0.135) E(1.5707963267948966 0 0)>
type:mesh mesh:'/home/sereact-mathias/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/collision/wrist1.stl'
 contact:-2 }
...
type:mesh mesh:'/home/sereact-mathias/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/visual/wrist2.ply'
color:[0.7 0.7 0.7 1.0]
colorName:LightGrey
 visual }
...
shape collision wrist_2_link_0 (wrist_2_link) {  
 color:[.8 .2 .2 .5],
rel=<T t(0 0 -0.12) E(0 0 0)>
type:mesh mesh:'/home/sereact-mathias/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/collision/wrist2.stl'
 contact:-2 }
...
type:mesh mesh:'/home/sereact-mathias/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/visual/wrist3.ply'
color:[0.7 0.7 0.7 1.0]
colorName:LightGrey
 visual }
...
shape collision wrist_3_link_0 (wrist_3_link) {  
 color:[.8 .2 .2 .5],
rel=<T t(0 0 -0.1168) E(1.5707963267948966 0 0)>
type:mesh mesh:'/home/sereact-mathias/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/collision/wrist3.stl'
 contact:-2 }
...
type:hingeX
axis:[0 0 1]
A:<t(2.66310255e-05 0.00000000e+00 0.00000000e+00) E( 1.57052728e+00 -5.03840511e-07  1.35556011e-10)>
limits:[-6.133185307179586 6.133185307179586]
limits:[-6.283185307179586 6.283185307179586]
ctrl_limits:[2.0943951023931953 330.0 1]
}
...
type:hingeX
axis:[0 0 1]
A:<t(7.61059859e-05 1.16026896e-01 8.90867742e-05) E(-1.57002852e+00 -5.17297692e-07 -3.97187172e-10)>
limits:[-6.133185307179586 6.133185307179586]
limits:[-6.283185307179586 6.283185307179586]
ctrl_limits:[3.141592653589793 56.0 1]
}
