...
type:mesh mesh:'/home/sereact/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/visual/base.ply'
...
shape collision base_link_inertia_0 (base_link_inertia) {  
 color:[.8 .2 .2 .5],
rel=<T t(0 0 0) E(0 0 3.141592653589793)>
type:mesh mesh:'/home/sereact/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/collision/base.stl'
 contact:-2 }
...
rel=<T t(0 0 0) E(0 0 3.141592653589793)>
type:mesh mesh:'/home/sereact/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/visual/shoulder.ply'
color:[0.7 0.7 0.7 1.0]
colorName:LightGrey
 visual }
...
shape collision shoulder_link_0 (shoulder_link) {  
 color:[.8 .2 .2 .5],
rel=<T t(0 0 0) E(0 0 3.141592653589793)>
type:mesh mesh:'/home/sereact/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/collision/shoulder.stl'
 contact:-2 }
...
type:mesh mesh:'/home/sereact/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/visual/upperarm.ply'
color:[0.7 0.7 0.7 1.0]
colorName:LightGrey
 visual }
...
shape collision upper_arm_link_0 (upper_arm_link) {  
 color:[.8 .2 .2 .5],
rel=<T t(0 0 0.1762) E(1.5707963267948966 0 -1.5707963267948966)>
type:mesh mesh:'/home/sereact/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/collision/upperarm.stl'
 contact:-2 }
...
type:mesh mesh:'/home/sereact/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/visual/forearm.ply'
color:[0.7 0.7 0.7 1.0]
colorName:LightGrey
 visual }
...
shape collision forearm_link_0 (forearm_link) {  
 color:[.8 .2 .2 .5],
rel=<T t(0 0 0.0393) E(1.5707963267948966 0 -1.5707963267948966)>
type:mesh mesh:'/home/sereact/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/collision/forearm.stl'
 contact:-2 }
...
type:mesh mesh:'/home/sereact/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/visual/wrist1.ply'
color:[0.7 0.7 0.7 1.0]
colorName:LightGrey
 visual }
...
shape collision wrist_1_link_0 (wrist_1_link) {  
 color:[.8 .2 .2 .5],
rel=<T t(0 0 -0.135) E(1.5707963267948966 0 0)>
type:mesh mesh:'/home/sereact/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/collision/wrist1.stl'
 contact:-2 }
...
type:mesh mesh:'/home/sereact/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/visual/wrist2.ply'
color:[0.7 0.7 0.7 1.0]
colorName:LightGrey
 visual }
...
shape collision wrist_2_link_0 (wrist_2_link) {  
 color:[.8 .2 .2 .5],
rel=<T t(0 0 -0.12) E(0 0 0)>
type:mesh mesh:'/home/sereact/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/collision/wrist2.stl'
 contact:-2 }
...
type:mesh mesh:'/home/sereact/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/visual/wrist3.ply'
color:[0.7 0.7 0.7 1.0]
colorName:LightGrey
 visual }
...
shape collision wrist_3_link_0 (wrist_3_link) {  
 color:[.8 .2 .2 .5],
rel=<T t(0 0 -0.1168) E(1.5707963267948966 0 0)>
type:mesh mesh:'/home/sereact/git/sereact/capto/assets/sim_models/robots/ur10e/meshes/collision/wrist3.stl'
 contact:-2 }
...
type:hingeX
axis:[0 0 1]
A:<t(0.         0.         0.18081651) E( 0.00000000e+00  0.00000000e+00 -2.21155208e-07)>
...
type:hingeX
axis:[0 0 1]
A:<t(6.81451088e-05 0.00000000e+00 0.00000000e+00) E( 1.56991352e+00  1.88611339e-07 -1.66507741e-10)>
limits:[-6.133185307179586 6.133185307179586]
limits:[-6.283185307179586 6.283185307179586]
ctrl_limits:[2.0943951023931953 330.0 1]
}
...
type:hingeX
axis:[0 0 1]
A:<t(-0.61246722  0.          0.        ) E(-7.43575636e-04  1.93630873e-03 -2.40352762e-06)>
...
type:hingeX
axis:[0 0 1]
A:<t(-0.57148487 -0.00098842  0.17418924) E( 5.67431860e-03 -1.54754950e-03 -1.70454793e-06)>
limits:[-6.133185307179586 6.133185307179586]
limits:[-6.283185307179586 6.283185307179586]
...
type:hingeX
axis:[0 0 1]
A:<t(-7.68956799e-05 -1.19809605e-01  4.49280558e-05) E( 1.57042133e+00  4.94752012e-07 -1.85529749e-10)>
limits:[-6.133185307179586 6.133185307179586]
limits:[-6.283185307179586 6.283185307179586]
ctrl_limits:[3.141592653589793 56.0 1]
}
...
type:hingeX
axis:[0 0 1]
A:<t(-4.25796387e-06  1.15424922e-01  1.01229558e-04) E(-1.56991931e+00 -1.98505283e-08 -1.74092405e-11)>
limits:[-6.133185307179586 6.133185307179586]
limits:[-6.283185307179586 6.283185307179586]
ctrl_limits:[3.141592653589793 56.0 1]
}
